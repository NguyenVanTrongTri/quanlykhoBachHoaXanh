                ...
                <div class="section-title">Thông tin tài khoản</div>
                    <div class="form-group">
                        <div class="form-field">
                            ...
                            <input type="text" id="mataikhoan" name="mataikhoan" autocomplete="off"readonly >
                        </div>
                        <div class="form-field">
                            <label for="ngaytao">Ngày tạo tài khoản</label>
                            <input type="datetime-local" id="ngaytao" name="ngaytao" readonly>
                        </div>
                        <div class="form-field">
                            <label for="tendangnhap">Tên đăng nhập</label>
                            <input type="text" id="tendangnhap" name="tendangnhap" placeholder="" readonly>
                        </div>
                        <div class="form-field">
                            <label for="mail"> Email</label>
                            <input type="text" id="mail" name="mail" placeholder="" readonly>
                        </div>
                        <div class="form-field">
                            <label for="matkhau"> Mật khẩu</label>
                            <input type="text" id="matkhau" name="matkhau" rows="4" placeholder="" readonly>
                        </div>
                         <div class="form-field">
                            <label for="sodienthoai">Số điện thoại</label>
                            <input type="text" id="sodienthoai" name="sodienthoai" placeholder="" readonly>
                        </div>
                        <div class="form-field">
                    ...
                    <thead>
                        ...
                        <tbody>
                            <?php
                                ...
                                if ((int)$row['isOnline'] === 1) {

                                    $status = "Đang hoạt động";
                                    $color = "green";

                                } elseif (!empty($row['trangthaihoatdong'])) {

                                    $lastActive = strtotime($row['trangthaihoatdong']);
                                    $now = time();
                                    $diff = $now - $lastActive;
                                    ...
                                    $color = "orange";
                                        ...
                                        $status = "Hoạt động {$hours} giờ trước";
                                        $color = "orange";

                                    } elseif ($days <= 3) {

                                        $status = "Hoạt động {$days} ngày trước";
                                        $color = "gray";

                                    } else {

                                        $status = "Hoạt động lúc " . date("H:i d/m/Y", $lastActive);
                                        $color = "gray";
                                    }
                                }
                       ...
                       <script>
                        document.querySelectorAll(".row-select").forEach(function(row) {
                            row.addEventListener("click", function() {
                                ...
                                document.getElementById("mataikhoan").value   = this.dataset.matk;
                                document.getElementById("tendangnhap").value  = this.dataset.tendangnhap;
                                document.getElementById("matkhau").value      = this.dataset.matkhau;
                                document.getElementById("mail").value         = this.dataset.email;
                                document.getElementById("sodienthoai").value  = this.dataset.sdt;
                                document.getElementById("gioitinh").value     = this.dataset.gioitinh;
                                document.getElementById("ngaytao").value      = this.dataset.ngaytao;
