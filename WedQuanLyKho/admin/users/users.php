...
<head>
    ...
    <style>
        ...
        :root { --bhx-green: #00923F; --bhx-yellow: #ffbc00; --bg-light: #f4f7f6; }
        body { margin: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: var(--bg-light); }
        .admin-container { display: flex; height: 100vh; }
        
        /* Sidebar giống admin.php */
        .admin-sidebar { width: 280px; background: #fff; border-right: 1px solid #ddd; padding: 20px; display: flex; flex-direction: column; }
        ...
        .admin-menu-item { display: flex; align-items: center; gap: 10px; padding: 12px 15px; text-decoration: none; color: #555; border-radius: 8px; margin-bottom: 5px; font-size: 14px; }
        .admin-menu-item:hover, .admin-menu-item.active { background: var(--bhx-green); color: #fff; }
        ...
        .grid-inputs { display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin-bottom: 20px; }
...
<div class="admin-container">
    <div class="admin-sidebar">
        ...
        <div class="user-profile">
            ...
            <div>
                <div style="font-weight:bold; font-size:14px;"><?= $tenNguoiDung ?></div>
                <div style="font-size:11px; color: var(--bhx-green);"><?= $me['ChucVu'] ?></div>
            </div>
        </div>
        <div style="flex: 1;">
            <a href="../admin.php" class="admin-menu-item"><i class="fa-solid fa-gauge-high"></i> Dashboard</a>
            <a href="users.php" class="admin-menu-item active"><i class="fa-solid fa-user-shield"></i> Tài khoản hệ thống</a>
            <a href="../nhanvien/QuanLyNhanVien.php" class="admin-menu-item"><i class="fa-solid fa-users"></i> Nhân sự</a>
        </div>
        <a href="../../logout.php" class="admin-menu-item" style="color:#e74c3c;"><i class="fa-solid fa-power-off"></i> Đăng xuất</a>
    </div>
